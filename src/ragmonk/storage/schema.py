"""DDL for the two SQLite databases RagMonk maintains.
...
# dedicated FTS5 index over file paths so ``ragmonk search``'s path
...
# independently searchable tokens of "src/ragmonk/retrieval/
